...
function RentDetailReportCar({
  rent: {
    numDays,
    Car: { carName, plateNumber, carImageURL, carPrice },
  },
}) {
  return (
    <div className="text-[10px] md:text-xs lg:text-sm">
      <div className="grid grid-cols-[1fr_1fr_1fr_1fr_1fr] bg-gray-50 p-1 font-semibold md:p-2">
      ...
      <div className="grid grid-cols-[1fr_1fr_1fr_1fr_1fr] p-2 lg:p-5">
        <div>
          <img
        ...
        <div className="content-center text-center">{numDays}</div>
