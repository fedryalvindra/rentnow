...
function Items({ listType }) {
  ...
  if (listType === 'paid')
    return (
      <ul className="h-[14rem] overflow-scroll border border-gray-200 text-[7px] md:text-xs xl:h-[22rem] xl:text-sm 2xl:text-lg">
        {listData.map((items) => (
  ...
  if (listType === 'sent')
    return (
      <ul className="h-[5.5rem] space-y-2 overflow-scroll border border-gray-200 text-[6px] md:h-[6rem] md:text-[8px] xl:h-[8rem] xl:text-sm 2xl:h-[10rem]">
        {listData.map((items) => (
  ...
  if (listType === 'outstock')
    return (
      <ul className="h-[5rem] space-y-1 overflow-scroll border border-gray-200 text-[6px] md:h-[6rem] md:text-xs xl:h-32 xl:text-lg 2xl:h-[9rem]">
        {listData.map((items) => (
